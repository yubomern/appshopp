...
const subtag = require("./controller/SubtagController");

const cattag = require("./controller/cattagController");
const productshopp = require("./controller/ProductshoppController");

const categoy =  require("./controller/CategoryController");


app.use("/api/v1/productshop", productshopp);
app.use('/api/v1/cat', categoy);


app.use('/api/v1/tag',tag);
app.use('/api/v1/subtag',subtag);
app.use("/api/v1/cattag", cattag);
